...
const lerp = (start, end, factor) => start * (2 * factor) + end * factor
...
const onDragEnd = () => {
    isDragging = false 
    menuElement.classList.remove("is-draggin") 
}

const animate = () => {
    requestAnimationFrame(animate)
    smoothScrollY = lerp(smoothScrollY, currentScrollPosition, 0.2)
...
function github() { window.open("https://github.com/lhagfoss", target="_blank") }